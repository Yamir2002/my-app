...
def dashboard(request):
    if request.method == "POST":
        ...
        product = Product(seller_name=seller_name, seller_phone=seller_phone, product_name=product_name, price=price, desc=desc, image=image, category=category, subcategory=subcategory)
        ...
        n = len(products)
        params = {'range': range(0,n),'product': products, 'category':category}
        tempSave(params)
