...
urlpatterns = [
    ...
    path('quote/<int:myid>',views.quote, name='Quote2'),
    path("products/<str:icategory>", views.categoryView, name="CategoryView"),
    path('products/<str:icategory>/<str:isub>', views.subcategoryView, name='SubcategoryView'),
